...
def run_model_generator_for_mitigation(file_num):
    ...
    main_df=None
    if(file_num=="1"):
        p=parent_dir + "/data/total_prediction_results/Datensatz1_results/fairness_measures/"
        main_df=pd.read_csv(parent_dir + "/data/total_prediction_results/Datensatz1_results/fairness_measures/Fairlearn_results_1.csv")
        side_df=pd.read_csv(parent_dir + "/data/total_prediction_results/Datensatz1_results/fairness_measures/Fairlearn_results_5.csv",index_col=0)
    elif(file_num=="2"):
        p=parent_dir + "/data/total_prediction_results/Datensatz2_results/fairness_measures/"
        main_df=pd.read_csv(parent_dir + "/data/total_prediction_results/Datensatz2_results/fairness_measures/Fairlearn_results_1.csv")
        side_df=pd.read_csv(parent_dir + "/data/total_prediction_results/Datensatz2_results/fairness_measures/Fairlearn_results_5.csv",index_col=0)
